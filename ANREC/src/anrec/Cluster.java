...
/**
 * Cette classe repr�sente un Cluter pour une m�thode de clustering k-mean.
 * Un cluster poss�de un centre, ainsi qu'une liste de points.
 * @author CLAVEL & AMAR
 * @version 1.0
 */
...
// Constructeur
	/**
	* Constructeur d'un Cluster �tant donn�es un centre
...
// M�thodes	
	 ...
	 * @param 	point	Point � ajouter au cluster
	 */
	 ...
	 * @param 	point	Point � enlever au cluster
	 */
